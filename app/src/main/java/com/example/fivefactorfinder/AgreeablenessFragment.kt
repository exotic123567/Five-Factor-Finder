 ...
 * Use the [AgreeablenessFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class AgreeablenessFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_agreeableness, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        personalityMap?.get("AGREEABLENESS")
            ?.let { personalityResultsExtroversion.put("AGREEABLENESS", it) }
        personalityMap?.get("Trust")
            ?.let { personalityResultsExtroversion.put("Trust", it) }
        personalityMap?.get("Morality")
            ?.let { personalityResultsExtroversion.put("Morality", it) }
        personalityMap?.get("Altruism")
            ?.let { personalityResultsExtroversion.put("Altruism", it) }
        personalityMap?.get("Cooperation")
            ?.let { personalityResultsExtroversion.put("Cooperation", it) }
        personalityMap?.get("Modesty")
            ?.let { personalityResultsExtroversion.put("Modesty", it) }
        personalityMap?.get("Sympathy")
            ?.let { personalityResultsExtroversion.put("Sympathy", it) }
        ...
        val labels = mutableListOf("AGREEABLENESS",
    ...
    companion object {
         ...
         * @return A new instance of fragment AgreeablenessFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AgreeablenessFragment().apply {
